...
(function(){
  ...
  // Example:
  // locals.localMethod = function(){};
  var locals = Paloma.locals['personas'] = {};
  ...
  Paloma.inheritLocals({from : '/', to : 'personas'});
})();
(function(){ 
  // Initializes the main container for all filters and skippers for this
  // specific scope.
  var filter = new Paloma.FilterScope('personas');
...
(function(){
  ...
  Paloma.callbacks['personas']['tags'] = function(params){
    // Do something here.
...
(function(){
  ...
  // Example:
  // locals.localMethod = function(){};
  var locals = Paloma.locals['mediasets'] = {};
  ...
  // Remove this line if you don't want to inherit locals defined
  // on parent's _locals.js
  Paloma.inheritLocals({from : '/', to : 'mediasets'});
})();
(function(){ 
  // Initializes the main container for all filters and skippers for this
  // specific scope.
  var filter = new Paloma.FilterScope('mediasets');
...
(function(){
  ...
  // Example:
  // locals.localMethod = function(){};
  var locals = Paloma.locals['photos'] = {};
  ...
  // Remove this line if you don't want to inherit locals defined
  // on parent's _locals.js
  Paloma.inheritLocals({from : '/', to : 'photos'});
})();
(function(){ 
  // Initializes the main container for all filters and skippers for this
  // specific scope.
  var filter = new Paloma.FilterScope('photos');
...
(function(){ 
  // Initializes the main container for all filters and skippers for this
  // specific scope.
  var filter = new Paloma.FilterScope('tags');
...
(function(){
  ...
  Paloma.callbacks['tags']['related'] = function(params){
    // Do something here.
		$(document).ready( function(){
			//load the related photos
			$.ajax({
				url: '/photos/get_more/' + $('.endless-photos').attr('last'),
				data: { mediatype:'related', focusPhotoID:params['photo_id'] } ,
				beforeSend: indicator.load('.endless_scoll_inner_wrap', 'after'), 
				dataType: 'script'
			});
			...
			$('#loadMore').click( function() {
				$.ajax({
					url: '/photos/get_more/' + $('.endless-photos').attr('last'),
					data: { mediatype:'related', focusPhotoID:params['photo_id']} ,
					beforeSend: indicator.load('.endless-photos', 'after'), 
					dataType: 'script'
				});
...
(function(){
  ...
  // Remove this line if you don't want to inherit locals defined
  // on parent's _locals.js
  Paloma.inheritLocals({from : '/', to : 'jobs'});
})();
(function(){ 
  // Initializes the main container for all filters and skippers for this
  // specific scope.
  var filter = new Paloma.FilterScope('jobs');
...
(function(){
  ...
  Paloma.callbacks['jobs']['get_more'] = function(params){
    // Do something here.
  };
})();
(function(){
...
(function(){
  ...
  Paloma.callbacks['jobs']['pending'] = function(params){
    // Do something here.
  };
})();
